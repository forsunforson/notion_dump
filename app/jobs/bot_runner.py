        ...
        try:
            ...
            system_prompt = "\n".join(
                [
                    ...
                    "",
                    "【回复风格】",
                    "当 save_reflection_record 调用成功后，你只需要用极简、冷峻的语气回复：已录制。或者基于用户的回答继续进行下一次更深度的苏格拉底追问。",
            ...
            executed = {"save_reflection_record": 0, "upsert_daily_metric": 0, "update_profile_attribute": 0, "log_portfolio_transaction": 0}
            ...
            tools = [METRICS_SKILL_SCHEMA, QUICK_DUMP_SKILL_SCHEMA, UPDATE_PROFILE_SKILL_SCHEMA, LOG_PORTFOLIO_TRANSACTION_SCHEMA]
            tool_map = {
